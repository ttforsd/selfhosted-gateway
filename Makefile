...
gateway: docker
	docker run --network gateway --restart unless-stopped -p 1667:80 -p 443:443 -p 80:80 -e NGINX_ENVSUBST_OUTPUT_DIR=/etc/nginx -it -d fractalnetworks/selfhosted-gateway:latest
